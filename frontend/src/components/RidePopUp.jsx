    ...
    return (
        <div>
            <div>
                ...
                <h3 className={'text-2xl font-semibold mb-5'}>Incoming Ride!</h3>
                ...
                <div className={'flex gap-2 justify-between flex-col items-center'}>
                    ...
                    <button onClick={() => {
                        ...
                        setPopupPanel(true);
                    }} className={'w-full mt-5  bg-green-600 text-white p-2 font-semibold rounded-lg'}>Accept
                    </button>

                    <button onClick={() => {
                        setPopupPanel(false);
                    }} className={'w-full bg-red-500 text-white p-2 font-semibold rounded-lg'}>Reject
                    </button>
                </div>
            </div>
        </div>
